 ...
 * - Non-2xx → `ApiError`, parsed from the shared error envelope (`@shared/errors`)
...
import { type ApiErrorBody, apiErrorSchema } from '@shared/errors'
...
export class ApiError extends Error {
   ...
   * purpose: parse it with the matching `@shared` schema rather than reading fields blind.
   */
