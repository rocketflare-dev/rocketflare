/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 7226e56a02dcab7adc05cc468bcd6d28)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "RELEASE_VERSION" | "LOG_LEVEL" | "EMAIL_FROM" | "TENANCY_MODE" | "SIGNUP_MODE" | "TENANT_SCOPE_MODE" | "AGENT_MAX_OUTPUT_TOKENS" | "AGENT_MAX_TURNS" | "APP_ENV" | "APP_URL" | "DATABASE_URL" | "OAUTH_ENCRYPTION_KEY" | "AUTH_SIGNING_KEY" | "RESEND_API_KEY" | "BOOTSTRAP_ADMIN_EMAILS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "ANTHROPIC_API_KEY" | "EMBEDDINGS_API_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "APP_DATABASE_URL">> {}
}
