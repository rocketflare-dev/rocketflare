/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 7e9c9b1ed03495ee0dc9227389961812)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "RELEASE_VERSION" | "LOG_LEVEL" | "EMAIL_FROM" | "TENANCY_MODE" | "SIGNUP_MODE" | "TENANT_SCOPE_MODE" | "AGENT_MAX_OUTPUT_TOKENS" | "AGENT_MAX_TURNS" | "CHAT_KNOWLEDGE_TOOLS" | "CHAT_HISTORY_MAX_CHARS" | "APP_ENV" | "APP_URL" | "DATABASE_URL" | "OAUTH_ENCRYPTION_KEY" | "FEATURES_ENABLED" | "AGENT_INTERRUPT_TIMEOUT" | "RESEND_API_KEY" | "BOOTSTRAP_ADMIN_EMAILS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "ANTHROPIC_API_KEY" | "EMBEDDINGS_API_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "APP_DATABASE_URL">> {}
}
