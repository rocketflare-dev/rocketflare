/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 017d1e58e31bcbddfe8c67ea95d8b4a0)
...
interface __BaseEnv_Env {
	...
	CHAT_KNOWLEDGE_TOOLS: string;
	CHAT_HISTORY_MAX_CHARS: string;
	OBSERVABILITY_CAPTURE_CONTENT: string;
	OBSERVABILITY_SPAN_RETENTION_DAYS: string;
	APP_ENV: string;
	APP_URL: string;
	DATABASE_URL: string;
	OAUTH_ENCRYPTION_KEY: string;
	FEATURES_ENABLED: string;
	AGENT_INTERRUPT_TIMEOUT: string;
	...
	OBSERVABILITY_PRESET: string;
	OTEL_EXPORTER_OTLP_ENDPOINT: string;
	OTEL_EXPORTER_OTLP_HEADERS: string;
	OBSERVABILITY_TRACE_URL: string;
	APP_DATABASE_URL: string;
	NOTIFICATIONS_HUB: DurableObjectNamespace<import("./src/worker").NotificationsHub>;
	AGENT_RUN_WORKFLOW: Workflow<Parameters<import("./src/worker").AgentRunWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "RELEASE_VERSION" | "LOG_LEVEL" | "EMAIL_FROM" | "TENANCY_MODE" | "SIGNUP_MODE" | "TENANT_SCOPE_MODE" | "AGENT_MAX_OUTPUT_TOKENS" | "AGENT_MAX_TURNS" | "CHAT_KNOWLEDGE_TOOLS" | "CHAT_HISTORY_MAX_CHARS" | "OBSERVABILITY_CAPTURE_CONTENT" | "OBSERVABILITY_SPAN_RETENTION_DAYS" | "APP_ENV" | "APP_URL" | "DATABASE_URL" | "OAUTH_ENCRYPTION_KEY" | "FEATURES_ENABLED" | "AGENT_INTERRUPT_TIMEOUT" | "RESEND_API_KEY" | "BOOTSTRAP_ADMIN_EMAILS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "ANTHROPIC_API_KEY" | "EMBEDDINGS_API_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "OBSERVABILITY_PRESET" | "OTEL_EXPORTER_OTLP_ENDPOINT" | "OTEL_EXPORTER_OTLP_HEADERS" | "OBSERVABILITY_TRACE_URL" | "APP_DATABASE_URL">> {}
}
